    ...
    <div class="container d-flex justify-content-center">
        <figure class="card card-product-grid card-lg"> <a href="#" class="img-wrap" data-abc="true"> <img src="../card.jpg"> </a>
            <figcaption class="info-wrap">
                <div class="row">
                    <div class="col-md-5 col-xs-5"> <a href="#" class="title removeHover" data-abc="true">RTX 3090</a> <span class="rated">ASIN</span> </div>
                    <div class="col-md-4 col-xs-4"> <a href="#" class="title removeHover" data-abc="true">$3,999</a> <span class="rated">Price</span> </div>
